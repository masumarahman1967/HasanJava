...
public class Operators {
  ...
  /*This is called expression.Here +,= are .....operator and a,b is an operands.

  1)Arithmetic operators .... +  -  *  /  %
  2)Relational/Comparison operators ....>  >=  <=  ==  !=
  3)Logical operators  .... &&  ||  !
  4)Increment & Decrement operators  ++  __
  5)Assignment  ...= +=  *=  /=  %=
  ...
  */
        ...
        System.out.println("Modulus Division of X and Y is: "+(x%y));//0
